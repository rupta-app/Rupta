-- Exclude groups the caller is already a member of from the Discover list.
-- Because the add_group_owner_member trigger inserts the owner as a member,
-- this also hides groups the caller owns. Signature is unchanged.
