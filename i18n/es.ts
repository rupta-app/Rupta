...
export const es: TranslationKeys = {
  ...
  complete: {
    ...
    tapToAdd: 'Tocá para agregar una foto',
    changePhoto: 'Cambiar',
    caption: 'Leyenda (opcional)',
    rating: '¿Cómo estuvo? (1–5)',
    coparticipants: 'Amigos que vinieron',
    submit: 'Enviar y ganar AURA',
    permissionDenied: 'Se necesita acceso a fotos',
    permissionSettings: 'Abrí Ajustes para permitir el acceso a la galería y subir tu prueba.',
