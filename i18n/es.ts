...
export const es: TranslationKeys = {
  ...
  groups: {
    ...
    searchPublicPlaceholder: 'Buscar grupos públicos…',
    noPublicGroups: 'No hay grupos públicos con esa búsqueda.',
    join: 'Unirse',
    ...
    settingsMembersOnly: 'Solo dueños y admins pueden cambiar los ajustes del grupo.',
  },
  profile: {
    settings: 'Ajustes',
    edit: 'Editar perfil',
