export const en = {
  ...
  groups: {
    ...
    rejectDraft: 'Reject',
    rejectDraftTitle: 'Reject draft?',
    rejectDraftConfirm: 'This will delete the draft quest. This cannot be undone.',
    draftApprovedTitle: 'Draft approved',
    draftApprovedBody: 'The quest is now active for the group.',
    joinedTitle: "You're in!",
    joinedBody: 'You joined {{groupName}}.',
    ...
    inviteFailedTitle: "Couldn't send invite",
    ...
    groupQuestDetails: 'Details',
    noQuestsYet: 'No quests yet.',
    noQuestsYetCta: 'Create the first one.',
    ...
    transferOwnershipEmpty: 'No eligible members.',
  ...
  notifications: {
    ...
    groupInviteMessage: 'Invited you to {{groupName}}.',
  },
  report: {
    title: 'Report',
